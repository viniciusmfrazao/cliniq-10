  ...
  return (
    <div className="space-y-6">
      ...
      <div className="space-y-4">
        ...
        <Tutorial title="Registrar pagamento (forma correta de lançar receita)" steps={['Abra o popup do agendamento e clique em \"Registrar Pagamento\"','Confira o(s) procedimento(s) — pode adicionar outro procedimento avulso na hora, se o paciente fechar mais um','Divida o pagamento em uma ou mais formas (Pix, dinheiro, crédito, débito), cada uma com sua própria taxa/parcelas calculadas automaticamente','Aplique desconto em valor ou percentual se for o caso','Se o paciente tiver débito em aberto, dá pra quitar direto por aqui','Quer vender um produto junto (ex: um creme)? Clique em \"Vender Produto\" dentro do próprio modal — vira um lançamento financeiro separado do procedimento','Confirme — a entrada fica vinculada ao paciente e ao atendimento automaticamente, alimentando a rentabilidade do paciente']} />
...
function TutorialFinanceiro() {
  return (
    <div className="space-y-6">
      ...
      <div className="space-y-4">
        <Tutorial title="Registrar entrada (receita)" steps={['A forma correta é pelo popup do agendamento na Agenda, botão \"Registrar Pagamento\" — assim a entrada já vem vinculada ao paciente e ao atendimento','Selecione forma(s) de pagamento; se cartão, informe bandeira e parcelas','O sistema calcula automaticamente taxa e valor líquido','Precisa corrigir um lançamento já feito? Vá em Financeiro → Entradas, clique no lápis e edite','Entrada sem atendimento vinculado (ex: venda de produto avulsa) tem seu próprio botão \"Vender Produto\"']} />
