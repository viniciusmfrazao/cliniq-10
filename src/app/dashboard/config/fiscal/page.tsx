...
export default async function FiscalPage() {
  ...
  const initialConfig = config ? {
    ...
    ibs_cbs_classificacao_padrao: config.ibs_cbs_classificacao_padrao,
    ibs_cbs_situacao_padrao: config.ibs_cbs_situacao_padrao,
    codigo_nbs: config.codigo_nbs,
    codigo_tributario_municipio: config.codigo_tributario_municipio,
