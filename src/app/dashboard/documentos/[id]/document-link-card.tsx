...
export default function DocumentLinkCard({ signUrl, patientName, patientPhone, docName }: Props) {
  ...
  const sendWhatsApp = () => {
    ...
    const message = encodeURIComponent(
      `Olá ${patientName || ''}!\n\nSegue o link para assinar o documento "${docName}":\n\n${signUrl}\n\nO link expira em 7 dias.`
    )
  ...
  return (
    <div className="card p-6">
      ...
      <p className="text-sm text-slate-500 mb-4">Envie este link para o paciente</p>
      
      <div className="bg-slate-50 rounded-xl p-3 mb-4">
        <p className="text-sm text-slate-700 break-all font-mono">{signUrl}</p>
      </div>
