...
import {
  ...
  ROLE_LABELS,
  COLOR_STYLES,
  MUTUALLY_EXCLUSIVE as LIB_MUTUALLY_EXCLUSIVE,
...
const DEFAULT_PERMISSIONS: Record<string, string[]> = { admin: ['all'], ...FACTORY_DEFAULTS }

const MUTUALLY_EXCLUSIVE: [string, string][] = LIB_MUTUALLY_EXCLUSIVE.map(
