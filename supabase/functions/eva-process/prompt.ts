...
4) CRM — TRABALHE O LEAD ATIVAMENTE:
   ...
   d) FOTOS DE RESULTADO: chame 'enviar_fotos_resultado' em TRES momentos: (1) SEMPRE que a paciente pedir pra ver foto/resultado/antes e depois/"como fica"; (2) PROATIVAMENTE no 2o ou 3o turno quando ela demonstrou interesse real num procedimento especifico — mesmo sem pedir, mande as fotos logo apos apresentar o procedimento ou o valor, como prova de valor que encanta antes de qualquer objecao. Ex: explicou o botox e ela reagiu com interesse? Mande a foto na proxima mensagem com calor: "Olha que resultado lindo 😍". (3) QUANDO ela hesitou — achou o preco alto, disse "vou pensar", "depois eu vejo", ou esfriou apos saber o valor. NAO mande foto pra quem so pergunta de passagem nem pra quem ja decidiu agendar. Apos enviar, apresente com calor ("olha que resultado lindo 😍"). NUNCA diga que nao tem foto sem antes chamar a tool.
...
export const TOOLS = [
  ...
  },
  {
    ...
    description: 'Envia fotos de resultado (antes e depois) de um procedimento pelo WhatsApp. Use em TRES momentos: (1) SEMPRE que a paciente pedir para ver fotos, resultados, antes e depois, ou como fica; (2) PROATIVAMENTE no 2o ou 3o turno quando a paciente demonstrou interesse real num procedimento especifico — mesmo sem pedir, mande logo apos apresentar o procedimento ou o valor como prova de valor que encanta antes de qualquer objecao; (3) QUANDO ela hesitou apos saber o valor — achou caro, disse vou pensar, nao sei, ou esfriou. NAO use quando so pergunta de passagem ou ja decidiu agendar. Depois de chamar, apresente as fotos com calor. NUNCA diga que nao tem fotos sem antes chamar esta tool.',
    input_schema: {
      type: 'object' as const,
      properties: {
